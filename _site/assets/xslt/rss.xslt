...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar data-options="scrolltop: false">
    <ul class="title-area">
      <li class="name">
      <h1 class="hide-for-large-up"><a href="http://localhost:4000" class="icon-tree"> Cheap and cheerful websites</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="Cheap and cheerful websites – Websites for all">
				<img src="http://localhost:4000/assets/img/logo.png" alt="Cheap and cheerful websites – Websites for all">
			</a>
